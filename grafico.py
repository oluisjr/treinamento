...
SENHA_EDICAO = st.secrets['SENHA_EDICAO']
...
ordem_areas_display = [
    ...
    "GEAL/GS - GERENCIA DE ALMOXARIFADO - PORTO REAL (APOIO)",
    "GGOP/GS - GERENCIA GERAL DE OPERACOES PORTO REAL",
    "GLR/GS - GERENCIA LOGISTICA REVERSA - PORTO REAL (APOIO)",
    "GPR-PLANPROG - SUPERVISAO DE PLANEJAMENTO E PROGRAMACAO",
    "GRHSI/GS - GERENCIA DE SAÚDE - PORTO REAL (APOIO)",
    "GSS/PL-GS - GERENCIA DE INTELIGENCIA E SEGURANÇA - PORTO REAL (APOIO)",
    "GST/GS - GERENCIA DE SEGURANCA DO TRABALHO - PORTO REAL (APOIO)",
